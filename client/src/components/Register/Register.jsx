...
function Register() {
  ...
  useEffect(() => {
    ...
    const matchResult =
      password === matchPassword && password != "" ? true : false;
            ...
            <form className="py-1" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="inputbox">
                  ...
                  <FontAwesomeIcon
                    icon={faCheck}
                    className={validUsername ? style.valid : style.hide}
                  />
                  <FontAwesomeIcon
                    icon={faTimes}
                    className={
                      !validUsername && username ? style.invalid : style.hide
                    }
                  />
                ...
                <div className="inputbox">
                  ...
                  <FontAwesomeIcon
                    icon={faTimes}
                    className={
                      !validEmail && email ? style.invalid : style.hide
                    }
                  />
                  ...
                  >
                    <FontAwesomeIcon icon={faInfoCircle} />
                    min 2 characters for top-level domain
                    <br />
                    Must inclue @ befor domain name
                    <br />
                ...
                <div className="inputbox">
                  ...
                  <FontAwesomeIcon
                    icon={faTimes}
                    className={
                      !validPassword && password ? style.invalid : style.hide
                    }
                  />
                ...
                <div className="inputbox">
                  ...
                  <FontAwesomeIcon
                    icon={faCheck}
                    className={validMatch ? style.valid : style.hide}
                  />
                  <FontAwesomeIcon
                    icon={faTimes}
                    className={
                      !validMatch && matchPassword ? style.invalid : style.hide
                    }
                  />
                ...
                <input
                  className={`${style.btn} ${
                    isButtonDisabled ? style.btnDisabled : {}
                  }`}
                  type="submit"
                  value="Sign Up"
                />
